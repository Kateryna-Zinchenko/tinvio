        ...
        <section className='faq'>
            <Wrapper>
                ...
                <Questions>
                    ...
                    <QuestionWrapper>
                        <Question onClick={() => onQuestionClick('How to get started with Tinvio?')}>
                            <Title>How to get started with Tinvio?</Title>
                            <PlusWrapper1 isOpen={isOpen} question={question}>
                                <Plus/>
                            </PlusWrapper1>
                            <MinusWrapper1 isOpen={isOpen} question={question}>
                                <Minus/>
                            </MinusWrapper1>
                        </Question>
                    ...
                    <QuestionWrapper>
                        <Question onClick={() => onQuestionClick('How does Tinvio work?')}>
                            <Title>How does Tinvio work?</Title>
                            <PlusWrapper2 isOpen={isOpen} question={question}>
                                <Plus/>
                            </PlusWrapper2>
                            <MinusWrapper2 isOpen={isOpen} question={question}>
                                <Minus/>
                            </MinusWrapper2>
                        </Question>
                    ...
                    <QuestionWrapper>
                        <Question onClick={() => onQuestionClick('How to collect payments on Tinvio?')}>
                            <Title>How to collect payments on Tinvio?</Title>
                            <PlusWrapper3 isOpen={isOpen} question={question}>
                                <Plus/>
                            </PlusWrapper3>
                            <MinusWrapper3 isOpen={isOpen} question={question}>
                                <Minus/>
                            </MinusWrapper3>
                        </Question>
                    ...
                    <QuestionWrapper>
                        <Question onClick={() => onQuestionClick('What are the supported payment methods?')}>
                            <Title>What are the supported payment methods?</Title>
                            <PlusWrapper4 isOpen={isOpen} question={question}>
                                <Plus/>
                            </PlusWrapper4>
                            <MinusWrapper4 isOpen={isOpen} question={question}>
                                <Minus/>
                            </MinusWrapper4>
                        </Question>
                    ...
                    <QuestionWrapper>
                        <Question onClick={() =>
                            onQuestionClick('I have more product questions! Who do I contact?')}>
                            <Title>I have more product questions! Who do I contact?</Title>
                            <PlusWrapper5 isOpen={isOpen} question={question}>
                                <Plus/>
                            </PlusWrapper5>
                            <MinusWrapper5 isOpen={isOpen} question={question}>
                                <Minus/>
                            </MinusWrapper5>
                        </Question>
